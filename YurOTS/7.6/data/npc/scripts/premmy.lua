...
selfSay('Você vai querer comprar PA por 10k?') 
talk_start = os.clock()
premium = 1
promoted = 0
end
...
selfSay('' .. creatureGetName(cid) .. ' você quer comprar "Promotion" 10k?')
promoted = true
else
promoted = false
selfSay('Você esta muito fraco!')
selfSay('Você pracisa de lvl 50 ou mais! Noob!')
end
end
...
if focus > 0 then 
selfSay('Até mais, ' .. creatureGetName(focus) .. '!') 
end 
