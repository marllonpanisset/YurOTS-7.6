 	...
 	if getPlayerAccess(cid) ~=0 then
 		...
 		repeat
 			...
 			if spawnrate==0 and summonedtotal ~= maxmonsters then
 				...
 				if species == 1 then
 					checkforsummon = doSummonCreature("holy elf scout",checking)
 				elseif species == 2 then					checkforsummon = doSummonCreature("holy elf arcanist",checking)
 				elseif species == 3 then
 					checkforsummon = doSummonCreature("holy elephant",checking)
 				elseif species == 4 then
 					checkforsummon = doSummonCreature("holy elf",checking)
 		...
 		--doPlayerSay(cid,"/B Lenórien está atacando!",23)
 				end
